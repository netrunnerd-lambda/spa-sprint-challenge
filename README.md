...
Client-side routes are handled by JavaScript and ultimately result in a part or parts of an
application to update rather than the entire page. They don't require a full page refresh.
Server-side routes refresh the page and render constant page elements all over again.
